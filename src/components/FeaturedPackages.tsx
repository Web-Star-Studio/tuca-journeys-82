...
// Extract PackageCard for better component organization
const PackageCard = ({ 
  pkg, 
  isHovered, 
  onMouseEnter, 
...
const FeaturedPackages = () => {
  ...
  // Memoize featured packages to prevent unnecessary recalculations
  const featuredPackages = useMemo(() => getFeaturedPackages(3), []);
