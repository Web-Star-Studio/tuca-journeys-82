        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/pacotes" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Pacotes
                </Link>
              </li>
              <li>
                <Link to="/passeios" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Passeios
                </Link>
              </li>
              <li>
                <Link to="/hospedagens" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Hospedagens
                </Link>
              </li>
              <li>
                <Link to="/loja" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Loja
                </Link>
              </li>
            </ul>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/sobre" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Sobre
                </Link>
              </li>
              <li>
                <Link to="/contato" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Contato
                </Link>
              </li>
              <li>
                <Link to="/privacidade" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Privacidade
                </Link>
              </li>
              <li>
                <Link to="/termos" className="text-muted-foreground hover:text-tuca-ocean-blue transition-colors">
                  Termos
                </Link>
              </li>
            </ul>
